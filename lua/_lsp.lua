		...
		config = function()
			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					map("<leader>fn", vim.lsp.buf.rename, "Rename")
					...
					map("K", require("telescope.builtin").lsp_definitions, "Goto Definition")

					-- WARN: This is not Goto Definition, this is Goto Declaration.
					--  For example, in C this would take you to the header.
					map("<leader>fk", vim.lsp.buf.declaration, "Goto Declaration")

					-- Fuzzy find all the symbols in your current document.
					--  Symbols are things like variables, functions, types, etc.
					map("<leader>fo", require("telescope.builtin").lsp_document_symbols, "Open Document Symbols")
					...
					map("<leader>ft", require("telescope.builtin").lsp_type_definitions, "Goto Type Definition")
